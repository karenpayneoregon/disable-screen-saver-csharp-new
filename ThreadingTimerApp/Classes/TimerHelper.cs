...
public class TimerHelper
{
    ...
    /// <summary>
    /// How long between intervals, currently 5 minutes
    /// </summary>
    public static int Interval = 1000 * 60 * 5;
    ...
    private static void Worker()
    {
        ...
        AnsiConsole.MarkupLine($"[white on red]{StopWatcher.Instance.ElapsedFormatted}[/]");
